...
- Added _Programmes Index_, _Academic Levels_, _Programmes_, _Departments_, _Testimonials_, _Events_, _Resources_, _Resources Index_, _Publications_, _Publications Index_, _People_, _People Index_, _News_ and _News Index_ sections.
- Added _Academic Level_, _Programme_, _Department_, _Testimonial_, _Event_, _Resource_, _Resource Link_, _Publication_, _Org Member_, _External Contributor_ and _News_ entry types.
